...
<Info>
  **Not sure which to pick?** If your agent runs in the terminal (Claude Code, custom pipelines), go with the **CLI**. If your IDE natively supports MCP (most do), go with the **MCP Server**. If you prefer a simpler setup or your agent supports skills, try the **Agent Skill**.
</Info>

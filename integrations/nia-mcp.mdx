...
<Tabs>
  <Tab title="New to Nia">
    ## Quick Install

    **Don't have an account yet?** Run this single command to get started:
    ...
    This will:
    - Open a browser to create your account
    - Generate your API key automatically
    - Configure your IDE with Nia MCP
    - Get you running in under a minute

    <Info>
      That's it! After running the command, follow the browser prompts and you're done.
    </Info>
  </Tab>

  <Tab title="Already have an API key">
    ## Configure Your IDE

    **Already have a Nia account?** Copy your API key from [app.trynia.ai](https://app.trynia.ai) and configure your IDE below.

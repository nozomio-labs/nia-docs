...
**Supported IDEs:**
`cursor`, `vscode`, `windsurf`, `cline`, `antigravity`, `trae`, `continue`, `roo-code`, `kilo-code`, `gemini-cli`, `opencode`, `qodo-gen`, `qwen-coder`, `visual-studio`, `crush`, `copilot-agent`, `copilot-cli`, `claude-code`, `factory`, `amp`

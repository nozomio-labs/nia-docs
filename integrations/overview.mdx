...
<CardGroup cols="2">
  ...
  <Card title="MCP Server" icon="plugin" href="/integrations/nia-mcp">
...
Simply override the base URL to `https://apigcp.trynia.ai` and add your Nia API key.

For tools that support Model Context Protocol (MCP), you can also use the Nia MCP server for direct codebase queries. See the [MCP integration guide](/integrations/nia-mcp) for details.

...
<CardGroup cols={3}>
  ...
  <Card title="X (Twitter)" icon="twitter" href="/x-twitter">
    Index posts from X accounts and search them alongside other sources.
  </Card>

  <Card title="Connectors" icon="plug" href="/connectors">
    Generic connector framework for integrating additional external data sources.
  </Card>
</CardGroup>
...
| X (Twitter) | [X Integration](/x-twitter) | `search` | Index and search public posts |
| Connectors | [Connectors](/connectors) | `search` | Generic connector framework for additional sources |

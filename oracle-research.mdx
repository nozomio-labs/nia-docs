...
<Info>
  **Pro Feature** - Oracle Research Agent is included with Pro and Startup plans. Free plan users can also use Oracle with purchased credits (10 credits per job).
</Info>

...
<AccordionGroup>
  ...
  <Accordion title="Universal Indexing Tools">
    ### `index`
    Universal indexing tool that intelligently detects and indexes GitHub repositories, documentation, or research papers.
  ...
  <Accordion title="Universal Search Tools">
    ### `search`
    Unified search across all indexed repositories, documentation, and research papers. Omit sources for universal hybrid search.
  ...
  <Accordion title="Resource Management">
    ### `manage_resource`
    Unified resource management tool for repositories, documentation, and research papers.

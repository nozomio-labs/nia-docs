...
Try it now in the [Interactive Playground →](https://app.trynia.ai/playground/datasets)

<Info>
HuggingFace dataset indexing uses **5 credits** per dataset. Large datasets (100K+ rows) are automatically sampled for efficient indexing while preserving representativeness.
</Info>
